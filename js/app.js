    ...
    function formRating() {
        ...
        function initRatings() {
            ...
            function setRatingActiveWidth(rating, index = ratingValue.innerHTML, hover = false) {
                if (rating.classList.contains("rating_custom")) {
 ...
 */    var MEDIA_PREFERS_REDUCED_MOTION = "(prefers-reduced-motion: reduce)";
    ...
    if (document.querySelector(".main-block__slider.splide")) {
        let mainSlider = new Splide(".main-block__slider.splide", {
            type: "loop",
            gap: 30,
            pagination: false,
            arrows: false,
            ...
            breakpoints: {
                991.98: {
                    arrows: {
                        prev: ".splide__arrow--main.splide__arrow--prev",
                        next: ".splide__arrow--main.splide__arrow--next"
                    },
                    autoWidth: true
                }
            }
        ...
        mainSlider.on("mounted", (function() {
            const mainSLides = document.querySelectorAll(".splide__slide--main");
            mainSLides.forEach((slide => {
                const imageSrc = slide.querySelector(".slide-main__image img").getAttribute("src"), imageTop = `<div class="slide-main__image-top"><img src="${imageSrc}" alt="Image"></div>`, contentBlock = slide.querySelector(".slide-main__content");
                contentBlock.insertAdjacentHTML(`beforeend`, imageTop);
            }));
        }));
        mainSlider.on("move", (function(newIndex, destIndex) {
            document.querySelectorAll(".splide__slide--main");
            document.querySelector(".main-block__slider.splide");
        }));
        mainSlider.mount();
        if (window.matchMedia("(min-width: 61.9988em)").matches) {
            let thumbs = new Splide(".splide--thumbs", {
                type: "loop",
                perPage: 1,
                gap: 20,
                arrows: {
            ...
            thumbs.on("mounted", (function() {
                const mainSLides = document.querySelectorAll(".splide__slide--thumbs");
                mainSLides.forEach((slide => {
                    const imageSrc = slide.querySelector(".slide-main__image img").getAttribute("src"), imageTop = `<div class="slide-main__image-top"><img src="${imageSrc}" alt="Image"></div>`, contentBlock = slide.querySelector(".slide-main__content");
                    contentBlock.insertAdjacentHTML(`beforeend`, imageTop);
                }));
    ...
    if (document.querySelector(".feedback__slider.splide")) {
        let feedbackSlider = new Splide(".feedback__slider.splide", {
            type: "loop",
            gap: 30,
            pagination: false,
            easing: "ease",
            arrows: {
                prev: ".splide__arrow--feed.splide__arrow--prev",
                next: ".splide__arrow--feed.splide__arrow--next"
            },
            speed: 800,
            breakpoints: {}
        });
